...
### **`rom.vhd`**: 
Representa a memória de instruções (ROM). Ela recebe o endereço do `ifetch` e retorna a instrução de 32 bits armazenada naquela posição. Ela é inicializada com um programa a partir de um arquivo `bitstream.bin`.
